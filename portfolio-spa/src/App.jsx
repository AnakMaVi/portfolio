...
const VIEW_CONTENT = {
  Inicio: {
    ...
    body: [
      ...
      'Liderazgo y gestión: Incremento del 25% en la velocidad de entrega del equipo mediante mentoría directa y la estructuración de flujos de trabajo eficientes con Git/GitLab y Jira.',
